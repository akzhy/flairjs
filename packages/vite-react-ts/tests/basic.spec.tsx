...
test("case-1", () => {
  ...
  const element = screen.getByText(/Case1/i);
...
test("case-2", () => {
  ...
  const element = screen.getByText(/Case2/i);
  expect(element).toBeInTheDocument();
...
test("case-3", () => {
  ...
  const element = screen.getByText(/Case3/i);
  expect(element).toBeInTheDocument();
...
test("case-4", () => {
  ...
  const element = screen.getByText(/Case4/i);
  expect(element).toBeInTheDocument();
...
test("case-5", async () => {
  ...
  const element = screen.getByText(/Case5/i);
  expect(element).toBeInTheDocument();
...
test("case-6", () => {
  ...
  const element = screen.getByText(/Case6/i);
  expect(element).toBeInTheDocument();
